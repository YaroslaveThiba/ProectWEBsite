...
@app.route('/obroza')
def namea():
    return render_template('obroza.html')
...
@app.route('/psihoa')
def psihoa():
    return render_template('psihoa.html')
...
@app.route('/razvla')
def razvla():
    return render_template('razvla.html')
...
def login():
    ...
    if request.method == "POST":
        ...
        if user and check_password_hash(user['psw'], request.form['psw']):
            ...
            return redirect(request.args.get("next") or url_for("ind"))
